...
export const metadata: Metadata = {
  title: 'Soumission gratuite - Asphalte | ZeniCorp',
  ...
  return (
    <div className="container-zenicorp py-12 max-w-2xl">
      <div className="text-center mb-10">
        <p className="text-zenicorp-gold font-semibold uppercase tracking-[0.2em] text-xs mb-3">Division Asphalte</p>
      ...
      <form className="card p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {['Scellant d\'asphalte', 'Réparation de fissures', 'Pavage & resurfaçage'].map((o) => (
        ...
        <div className="mb-8">
          <h2 className="heading-3 mb-4 flex items-center gap-2">
            <span className="text-zenicorp-gold font-bold">4.</span> Dimensions de la surface
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="mb-8">
          ...
          <textarea className="input-field min-h-32" placeholder="Décrivez votre projet : état de l'asphalte, fissures, nids-de-poule, pente, drain français..." />
        </div>

        {/* ÉTAPE 6 */}
        <div className="mb-8">
          <h2 className="heading-3 mb-4 flex items-center gap-2">
            <span className="text-zenicorp-gold font-bold">6.</span> Photos de la surface
          </h2>
        ...
        <div className="mb-8 bg-zenicorp-lightGray border border-zenicorp-border p-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            {[
              ['Type de projet', 'Scellant d\'asphalte'],
