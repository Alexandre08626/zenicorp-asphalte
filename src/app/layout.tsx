...
export const metadata: Metadata = {
  ...
  keywords: ['asphalte', 'pavage', 'scellant', 'réparation fissures', 'allée', 'stationnement', 'ZeniCorp', 'Québec'],
  openGraph: {
    type: 'website',
    locale: 'fr_CA',
    siteName: 'ZeniCorp Asphalte',
    title: 'ZeniCorp Asphalte | Pavage, scellant et réparation',
    description: 'Scellant, réparation, pavage. Garantie incluse. Soumission gratuite.',
  },
};
          ...
          <div className="container-zenicorp flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2">
              ...
              <div className="leading-tight">
                ...
                <span className="block text-[10px] uppercase tracking-[0.25em] text-zenicorp-gold">Asphalte</span>
              </div>
            </Link>
        ...
        <footer className="bg-zenicorp-black text-white">
          <div className="container-zenicorp py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-zenicorp-silver">Division Asphalte. Une division de ZeniCorp Groupe Construction.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-4 text-zenicorp-gold">Services</h3>
              <ul className="space-y-2 text-sm text-zenicorp-silver">
                <li><Link href="/#services" className="hover:text-white">Scellant d'asphalte</Link></li>
                <li><Link href="/#services" className="hover:text-white">Réparation de fissures</Link></li>
                <li><Link href="/#services" className="hover:text-white">Pavage & resurfaçage</Link></li>
              </ul>
            </div>
            <div>
